...
class yfs_client {
 ...
 private:
  ...
  int local_create(inum, const char *, uint32_t, inum&);
  int local_lookup(inum, const char *, bool &, inum &);
  int local_readdir(inum, std::list<dirent> &);
