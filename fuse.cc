        ...
        int to_set, struct fuse_file_info *fi)
{
    ...
    /***add SET_ATTR_ATIM and SET_ATTR_MTIME for test-d.sh***/
...
//
// Create a new symbolic link with name @name in parent directory @parent.
//
void
...
//
// read symbolic link of inode number @ino
//
void
